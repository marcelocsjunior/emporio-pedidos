...
AI_ACTIVE_ASSISTANT_ENABLED = os.getenv("AI_ACTIVE_ASSISTANT_ENABLED", "0") == "1"
AI_ACTIVE_ASSISTANT_POLL_SECONDS = max(
    10,
    int(os.getenv("AI_ACTIVE_ASSISTANT_POLL_SECONDS", "15")),
)
AI_ACTIVE_ASSISTANT_PROMPT_VERSION = os.getenv(
    "AI_ACTIVE_ASSISTANT_PROMPT_VERSION",
    "mvp-ia-03-v1",
)
